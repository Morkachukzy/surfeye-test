  ...
  (
    ...
    return (
      <button
        ref={ref}
        className={cn(
          'flex flex-shrink-0 items-center gap-3 leading-none uppercase italic font-bold text-brand-md md:text-xl rounded-full select-none py-3.5 px-6 md:px-[1.875rem] justify-center',
