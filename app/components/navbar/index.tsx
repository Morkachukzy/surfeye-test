...
export const Navbar = () => {
  return (
    <div className="bg-brand-primary rounded-b-brand-200 overflow-hidden">
      <div className="bg-brand-light rounded-b-brand-200 p-2 px-24 flex items-center gap-10">
        <ChevronLeftIcon />
        <span className="text-3xl italic font-semibold">Nova praia</span>
      </div>
      <div className="bg-brand-primary pb-[.875rem] pt-2 px-24 flex items-center justify-between">
        <AppLogo />
